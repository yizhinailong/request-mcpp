...
export namespace mcr {
    ...
    struct VerifySsl {
        ...
        /** @brief Store the verification preference. @param value Whether to verify. */
        VerifySsl(bool value) : verify{ value } {}

        /** @brief Inspect the stored preference. @return Whether to verify. */
    ...
    namespace ssl {
        ...
        public:
            ...
            /** @brief Own a certificate path. @param value Path to the certificate. */
            CertFile(std::filesystem::path value) : filename{ std::move(value) } {}

            virtual ~CertFile() = default;

            /** @brief Select PEM encoding. @return Curl certificate type. */
        ...
        public:
            ...
            /** @brief Own certificate bytes. @param value Certificate contents. */
        ...
        public:
            ...
            /** @brief Own a key path and passphrase. @param value Key path. @param passphrase Optional key password. */
            ...
            /** @brief Select PEM encoding. @return Curl key type. */
        ...
        public:
            ...
            /** @brief Own key bytes and a passphrase. @param value Key contents. @param passphrase Optional key password. */
        ...
        struct PinnedPublicKey {
            ...
            /** @brief Own the option value. @param value Pinned public key filename or sha256 hash list. */
        ...
        struct CaInfo {
            ...
            /** @brief Own the option value. @param value CA bundle filename. */
        ...
        struct CaInfoBlob {
            ...
            /** @brief Own the option value. @param value CA bundle bytes. */
        ...
        struct CaPath {
            ...
            /** @brief Own the option value. @param value CA certificate directory. */
        ...
        struct CaBuffer {
            ...
            /** @brief Own the option value. @param value CA bundle bytes applied through curl's copied CAINFO_BLOB. */
        ...
        struct Crl {
            ...
            /** @brief Own the option value. @param value Certificate revocation list filename. */
        ...
        struct Ciphers {
            ...
            /** @brief Own the option value. @param value TLS cipher selection. */
        ...
        struct TLS13_Ciphers {
            ...
            /** @brief Own the option value. @param value TLS 1.3 cipher selection. */
        ...
        struct ALPN {
            ...
            /** @brief Store the preference. @param value Whether to enable it. */
            ALPN(bool value) : enabled{ value } {}

            /** @brief Inspect the preference. @return Whether enabled. */
    ...
    struct SslOptions {
        ...
        /** @brief Select a certificate file and clear blob storage. @param opt Certificate option. */
        ...
        /** @brief Select a certificate blob and clear the file path. @param opt Certificate option. */
        ...
        /** @brief Select a key file and password, clearing blob storage. @param opt Key option. */
        ...
        /** @brief Select a key blob and password, clearing the file path. @param opt Key option. */
        ...
        /** @brief Apply CaInfoBlob. @param opt Value to copy. */
        ...
        /** @brief Apply CaPath. @param opt Value to copy. */
        auto SetOption(ssl::CaPath const& opt) -> void { ca_path = opt.filename.string(); }

        /** @brief Apply CaBuffer. @param opt Value to copy. */
